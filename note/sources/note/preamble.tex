...
\input{fonts_linux}% не забудьте закомментировать \input{fonts_linux}
...
\DeclareCaptionLabelFormat{stbfigure}{Рисунок \textit{#2}}
...
\captionsetup[figure]{labelformat=stbfigure,justification=centering,skip=15pt,width=0.8\linewidth}
